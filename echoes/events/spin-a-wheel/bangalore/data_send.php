...
$token=getToken(6);
	 ...
	 echo mysql_select_db($dbname,$link);   
 	 $result2=mysql_query($query2);
 	if($result2 && mysql_num_rows($result2) > 0){
		header('Location: http://echoes.stargazer.co.in/events/spin-a-wheel/bangalore/index.php?tag=fail'); 	
		}
 	else{
	 ...
	 $_SESSION["number"]=$num;
	    ...
	    header('Location: spin-bangalore.php');
	    }
