...
$contacts = $num;
$from = 'ECHOES'; $sms_text = urlencode('Echoes, Koramangala welcomes you to redeem code : '.$coupon.' for offer :'.$prize.'-'.$offer.' Visit Now! T&C apply #EEE Offer valid till '. $formatdate );
