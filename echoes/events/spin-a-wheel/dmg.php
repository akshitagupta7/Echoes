...
$hostname="localhost";
	...
	$usertable="people_spinner";
	 ...
	 $query="SELECT prize,couponcode,DATE(TIMESTAMP) FROM $usertable WHERE phone='$num'";
...
$contacts = $num;
$from = 'ECHOES'; $sms_text = urlencode('Echoes,Satyaniketan welcomes you to redeem code : '.$coupon.' for offer :'.$prize.'-'.$offer.' Visit Now! T&C apply #EEE Offer valid till '. $formatdate );
